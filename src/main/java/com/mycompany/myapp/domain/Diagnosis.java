...
public class Diagnosis implements Serializable {
    ...
    public Diagnosis amount(Double amount) {
        this.amount = amount;
        return this;
    }
    ...
    public Diagnosis company(String company) {
    ...
    public Diagnosis type(String type) {
        this.type = type;
        return this;
    }
    ...
    public Diagnosis phone(String phone) {
        this.phone = phone;
        return this;
    }
    ...
    public Diagnosis idStaff(Long idStaff) {
