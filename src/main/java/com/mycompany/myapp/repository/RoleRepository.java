...
public interface RoleRepository extends JpaRepository<Role, Long> {
    ...
    @Query(value = "select distinct role from Role role left join fetch role.accesses",
    ...
    @Query("select role from Role role left join fetch role.accesses where role.id =:id")
